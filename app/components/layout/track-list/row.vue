...
<template>
  <div
    class="col-span-full grid grid-cols-subgrid group-data-[row-style=bordered]:not-last:border-b group-data-[row-style=bordered]:not-last:gap-0 group-data-[row-style=alternating-background]:data-is-even:bg-muted/25"
    :class="{
